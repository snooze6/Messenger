...
public class _ServerContractStub extends org.omg.CORBA.portable.ObjectImpl implements Messenger.ServerContract
{
  ...
  public boolean makeFriends (String user1, String user2)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("makeFriends", true);
                $out.write_string (user1);
                $out.write_string (user2);
                $in = _invoke ($out);
                boolean $result = $in.read_boolean ();
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                ...
                return makeFriends (user1, user2        );
            } finally {
                _releaseReply ($in);
            }
  } // makeFriends

  public String[] getFriendRequest (String user)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getFriendRequest", true);
                $out.write_string (user);
                $in = _invoke ($out);
                String $result[] = Messenger.requestsHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
